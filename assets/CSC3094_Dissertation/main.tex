...
In all self-hosted cases the per-transaction inference cost is two to three orders of magnitude below the alert-investigation cost (USD~$30$--$70$ per alert, LexisNexis~2024~\cite{lexisnexis2024costukfc}). Inference compute is therefore not the economic constraint on adoption; investigator capacity is.
